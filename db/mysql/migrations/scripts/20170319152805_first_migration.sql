...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`actions` (
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`authors` (
  `id` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`trade_history` (
  `id` BINARY(16) NOT NULL,
  `price` DECIMAL(18,2) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`roles` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`tracks` (
  `id` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`user_to_role` (
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`user_to_album` (
  `user_id` BINARY(16) NOT NULL,
  `album_id` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE `music_store`.`album_to_genre` (
...
DROP TABLE `music_store`.`album_to_genre`;

DROP TABLE `music_store`.`user_to_album`;

DROP TABLE `music_store`.`user_to_role`;

DROP TABLE `music_store`.`genres`;

DROP TABLE `music_store`.`tracks`;

DROP TABLE `music_store`.`roles`;

DROP TABLE `music_store`.`trade_history`;

DROP TABLE `music_store`.`albums`;

DROP TABLE `music_store`.`authors`;

DROP TABLE `music_store`.`users`;

DROP TABLE `music_store`.`actions`;
